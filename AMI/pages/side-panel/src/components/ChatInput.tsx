...
interface ChatInputProps {
  ...
  onStopTask: () => void;
  onMicClick?: () => void;
  voiceInputState?: 'idle' | 'listening' | 'processing' | 'error';
  disabled: boolean;
...
export default function ChatInput({
  ...
  const isRecording = voiceInputState === 'listening';
  const isProcessingSpeech = voiceInputState === 'processing';
  const hasVoiceError = voiceInputState === 'error';
