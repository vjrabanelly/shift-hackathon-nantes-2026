      ...
      <div
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={`text-base font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                {t('options_general_enableDialogueMode')}
              </h3>
              <p className={`text-sm font-normal ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                {t('options_general_enableDialogueMode_desc')}
              </p>
            </div>
            <div className="relative inline-flex cursor-pointer items-center">
              <input
                id="enableDialogueMode"
                type="checkbox"
                checked={settings.enableDialogueMode}
                onChange={e => updateSetting('enableDialogueMode', e.target.checked)}
                className="peer sr-only"
              />
              <label
                htmlFor="enableDialogueMode"
                className={`peer h-6 w-11 rounded-full ${isDarkMode ? 'bg-slate-600' : 'bg-gray-200'} after:absolute after:left-[2px] after:top-[2px] after:size-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300`}>
                <span className="sr-only">{t('options_general_enableDialogueMode')}</span>
              </label>
            </div>
          </div>

          {settings.enableDialogueMode && (
            <div className="flex items-center justify-between">
              <div>
                <h3 className={`text-base font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  {t('options_general_dialogueSilenceTimeout')}
                </h3>
                <p className={`text-sm font-normal ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                  {t('options_general_dialogueSilenceTimeout_desc')}
                </p>
              </div>
              <label htmlFor="dialogueSilenceTimeout" className="sr-only">
                {t('options_general_dialogueSilenceTimeout')}
              </label>
              <input
                id="dialogueSilenceTimeout"
                type="number"
                min={1}
                max={30}
                value={Math.round(settings.dialogueSilenceTimeoutMs / 1000)}
                onChange={e => {
                  const seconds = Math.max(1, Math.min(30, Number(e.target.value) || 5));
                  void updateSetting('dialogueSilenceTimeoutMs', seconds * 1000);
                }}
                className={`w-20 rounded-md border ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200' : 'border-gray-300 bg-white text-gray-700'} px-3 py-2 text-center`}
              />
            </div>
          )}
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={`text-base font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                {t('options_general_useElevenLabs')}
              </h3>
              <p className={`text-sm font-normal ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                {t('options_general_useElevenLabs_desc')}
              </p>
            </div>
            <div className="relative inline-flex cursor-pointer items-center">
              <input
              ...
              />
              <label
                htmlFor="useElevenLabs"
                className={`peer h-6 w-11 rounded-full ${isDarkMode ? 'bg-slate-600' : 'bg-gray-200'} after:absolute after:left-[2px] after:top-[2px] after:size-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-blue-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300`}>
                <span className="sr-only">{t('options_general_useElevenLabs')}</span>
              </label>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className={`text-base font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                {t('options_general_elevenLabsVoiceId')}
              </h3>
              <p className={`text-sm font-normal ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                {t('options_general_elevenLabsVoiceId_desc')}
              </p>
            </div>
            <label htmlFor="elevenLabsVoiceId" className="sr-only">
              {t('options_general_elevenLabsVoiceId')}
            </label>
            <input
              ...
              className={`w-56 rounded-md border ${isDarkMode ? 'border-slate-600 bg-slate-700 text-gray-200' : 'border-gray-300 bg-white text-gray-700'} px-3 py-2`}
            />
          </div>
        </div>
      </div>
